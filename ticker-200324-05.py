...
- Added time of peak stock/lowest FX values"""
...
while True:
    ...
    print()
    print(str.ljust(symbol.upper() + ":", col1) + str.ljust("$" + str(stockprice), col2) + str.ljust("H: " + str(bestprice) + " @ " + peakstocktime ,col3) + str.rjust(pdelta,col4a))
    if (currency != "usd"):
        print(str.ljust(currency.upper() + ":", col1) + str.ljust("x" + str(currval), col2) + str.ljust("L: " + str(lowfx) + " @ " + lowfxtime,col3) + str.rjust(fdelta,col4a))
    ...
    if firstrun:
        bestvalue = value
        print(str.ljust("BEST:", col1) + str.ljust(csymb + str(bestvalue), col2) + str.ljust("@ " + peakvaluetime, col3))
    elif (value > bestvalue):
        bestvalue = value
        peakvaluetime = now
        print('\33[7m' + str.ljust("BEST:", col1) + str.ljust(csymb + str(value), col2) + str.ljust("@ " + peakvaluetime, col3) + '\33[0m' + '\a')
    elif (value == bestvalue):
        print('\33[7m' + str.ljust("BEST:", col1) + str.ljust(csymb + str(value), col2) + str.ljust("@ " + peakvaluetime, col3) + '\33[0m')
    else:
        print(str.ljust("BEST:", col1) + str.ljust(csymb + str(bestvalue), col2) + str.ljust("@ " + peakvaluetime, col3))
    firstrun = False
    print()
